...
export const ProfilesList: ProfileData[] = [
    ...
    experience: [
      {
        ...
        role: "UI UX Designer",
        summary:
          "<ul><li>Created user-friendly wireframes and mobile app prototypes using Figma to enhance user experience.</li><li>Designed portfolio website layout with a focus on clean interface and intuitive navigation.</li><li>Collaborated with developers to ensure accurate implementation of UI/UX designs.</li></ul>",
      },
    ],
  ...
  },
  {
    ...
    experience: [
      {
        ...
        summary:
          "<ul><li>Designed product interfaces and user flows for the vehicle management with the booking facilities , contributing to the overall user experience of the platform.</li><li>Created API documentation to facilitate easy understanding and implementation.</li></ul>",
        website: "",
      },
    ],
    mentorBridgeExp: {
    ...
    skillSets: ["React", "TypeScript", "Node.js", "AWS"],
